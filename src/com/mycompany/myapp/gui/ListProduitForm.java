...
public class ListProduitForm extends BaseForm{
    ...
    public ListProduitForm(Resources res)
    {
       ...
       addTab(swipe,s1,res.getImage("complaint.png"),"","",res);
        ...
        RadioButton liste = RadioButton.createToggle("Modifier Produit", barGroup);
    ...
    private void addButton(Image img, Produit rec,Resources res) {
        ...
        Label prixTxt = new Label("description : "+rec.getPrix(),"NewsTopLine2");
           Label quantiteTxt = new Label("description : "+rec.getQuantite(),"NewsTopLine2");
...
//butt supprimer
        ...
        lSupprimer.addPointerPressedListener(l->{
            ...
            if(dig.show("Supression","Vous Voulez supprimer cette Produit ?","Annuler","oui"))
            {
                dig.dispose();
            }
            else{
