...
public class StatistiquePieForm extends BaseForm {
    ...
    private double nbr_feedback_positive = 45;
    private double nbr_feedback_negative = 29;
    Form current;
BaseForm form;
        ...
        Label spacer2 = new Label();
         addTab(swipe,res.getImage("profile-background.jpg"),spacer1,"Bienvenue");
        ...
        RadioButton popular = RadioButton.createToggle("Categorie Produit", barGroup);
  ...
  ;       
       ...
       image.addActionListener(e -> {
           try{
           new AjoutProduitForm(Resources.getGlobalResources()).show();
           }catch(Exception exx) {
 ...
 //Stat
    ...
    {
        double total = nbr_feedback_positive + nbr_feedback_negative;
        double prcntPositive = (nbr_feedback_positive * 100)/total;
        double prcntNegative = (nbr_feedback_negative * 100)/total;
        //colors
        ...
        PieChart chart = new PieChart(buildDataset("title",Math.round(prcntPositive),Math.round(prcntNegative)),renderer);
        //ajouter la charte dans component
        ChartComponent c = new ChartComponent(chart);
        
        String []messages = {
            "Staistique Produits positive % Produits Negative"
        };
        
      SpanLabel message = new SpanLabel(messages[0],"WelcomeMessage");
      /////lena 12:55
      Container cnt = new BorderLayout().center(message);
    ...
    private CategorySeries buildDataset(String title, double prcntPositive, double prcntNegative) {
        CategorySeries series = new CategorySeries(title);
        series.add("Produits Positive",prcntPositive);
        series.add("Produits Negative",prcntNegative);
