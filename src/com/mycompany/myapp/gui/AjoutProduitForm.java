...
public class AjoutProduitForm extends BaseForm{
    ...
    public AjoutProduitForm(Resources res)
    {
       ...
       addTab(swipe,s1,res.getImage("gestion-des-réclamations.jpg"),"","",res);
        ...
        RadioButton liste = RadioButton.createToggle("Modifier Produits", barGroup);
        liste.setUIID("SelectBar");
        RadioButton partage = RadioButton.createToggle("Ajouter Produits", barGroup);
        ...
        btnAjouter.addActionListener((e)->{
            try {
                if(nom.getText().equals("") || prix.getText().equals("") || quantite.getText().equals(""))
                {
...
//                    Produit r = new Produit(String.valueOf(nom.getText()
//                    ).toString(),
//                            prix.getText().toString() ,prix.getText().toString());

Produit r = new Produit(nom.getText(), Integer.parseInt(prix.getText()), Integer.parseInt(prix.getText()));
                   
                    
                    System.out.println("data Produit == "+r);
                    ServiceProduit.getInstance().ajouterProduits(r);
                    iDialog.dispose();
