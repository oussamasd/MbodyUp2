 ...
 * @author user
 */
public class ModifierCategoriesForm extends BaseForm{
     Form current;
    public ModifierCategoriesForm(Resources res, Categories r )
    {
        ...
        if(ServiceCategories.getInstance().modifierCategorie(r))
        {
