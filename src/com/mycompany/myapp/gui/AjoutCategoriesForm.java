 ...
 * @author user
 */
public class AjoutCategoriesForm extends BaseForm{
     Form current;
    Categories rec = new Categories();
    public AjoutCategoriesForm(Resources res)
    {
       ...
       //
        ...
        Component.setSameSize(radioContainer, s1);
        ...
        RadioButton partage = RadioButton.createToggle("Ajouter Categories", barGroup);
...
//                    SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd");
                    Categories r = new Categories(String.valueOf(nom.getText()).toString(),
                    ...
                    ServiceCategories.getInstance().ajouterCategorie(r);
                    iDialog.dispose();
